...
-(void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated{
    ...
    if ([viewController isKindOfClass:[SjjBaseControllerViewViewController class]]) {
        SjjBaseControllerViewViewController * vc = (SjjBaseControllerViewViewController *)viewController;
